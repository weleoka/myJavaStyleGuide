...
#### Some further point that should be documented

* Docstring/javadoc standards could be included
* Singleton methods decleration point in class.
* Multiline assignments. Curly braces start on declaration line.
    Example:
    ```java
    String[] tmpArr = {
        this.name,
    ...
    ```
* Make inline comment specifications. finish with full stop. Question: how many spaces before beginning the double forwardslash?

This style guide is based on the following: [JavaRanch](https://www.javaranch.com/styleLong.jsp)
